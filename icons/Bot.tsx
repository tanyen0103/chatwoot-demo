...
const BotIcon = ({ className }: { className: string }) => {
  return (
    ...
    >
      <path
        fill="#e06055"
        d="M86.05 35.16H41.64V21.19c0-6.51 5.27-11.78 11.78-11.78h20.85c6.51 0 11.78 5.27 11.78 11.78v13.97z"
      ></path>
      <path
        fill="#fff"
        d="M55.12 11.62c-.64-1.89-4.14-.77-5.95.32s-4.34 3.97-3.43 4.7c.9.72 2.38-1.12 5.53-1.99c2.93-.81 4.38-1.47 3.85-3.03z"
      ></path>
      <path
        fill="#ce453e"
        d="M88.73 24.77H39.01v-2.1a3.24 3.24 0 0 1 3.24-3.24H85.5a3.24 3.24 0 0 1 3.24 3.24v2.1z"
      ></path>
      <path
        fill="#78a3ad"
        d="m119.73 58.05l2.06-45.88a2.612 2.612 0 0 1 5.22.12v58.98c0 .83-.4 1.62-1.07 2.11l-7.41 5.41l1.2-20.74zm-111.46 0L6.22 12.17a2.622 2.622 0 0 0-2.61-2.49C2.17 9.68 1 10.85 1 12.29v58.98c0 .83.4 1.62 1.07 2.11l7.41 5.41l-1.21-20.74z"
      ></path>
      <ellipse
        cx="13.69"
        cy="66.89"
      ...
      <clipPath id="iconifyVue1">
        <use href="#iconifyVue0"></use>
      </clipPath>
      <path
        fill="#ce453e"
        d="M12.22 49.54h2.62v34.69h-2.62z"
        clipPath="url(#iconifyVue1)"
      ></path>
      <defs>
        <ellipse
          id="iconifyVue2"
      ...
      <clipPath id="iconifyVue3">
        <use href="#iconifyVue2"></use>
      </clipPath>
      <path
        fill="#ce453e"
        d="M12.54 49.54h2.62v34.69h-2.62z"
        clipPath="url(#iconifyVue3)"
      ...
      <clipPath id="iconifyVue5">
        <use href="#iconifyVue4"></use>
      </clipPath>
      <path
        fill="#ce453e"
        d="M113.23 49.54h2.62v34.69h-2.62z"
        clipPath="url(#iconifyVue5)"
      ...
      <clipPath id="iconifyVue7">
        <use href="#iconifyVue6"></use>
      </clipPath>
      <path
        fill="#ce453e"
        d="M112.91 49.54h2.62v34.69h-2.62z"
        clipPath="url(#iconifyVue7)"
      ></path>
      <path
        fill="#78a3ad"
        d="m111.12 35.15l-11.07-10.82a10.841 10.841 0 0 0-7.58-3.09H35.73c-2.83 0-5.55 1.11-7.58 3.09L17.08 35.15a10.816 10.816 0 0 0-3.26 7.75v54.02c0 2.92 1.18 5.71 3.26 7.75l11.07 10.82c2.03 1.98 4.74 3.09 7.58 3.09h56.74c2.83 0 5.55-1.11 7.58-3.09l11.07-10.82c2.09-2.04 3.26-4.83 3.26-7.75V42.9c0-2.91-1.18-5.71-3.26-7.75z"
      ></path>
      <circle cx="40.28" cy="55.89" r="14.63" fill="#546e7a"></circle>
      <circle cx="40.28" cy="55.89" r="9.2" fill="#b8e9f4"></circle>
      <circle cx="86.96" cy="55.89" r="14.63" fill="#546e7a"></circle>
      <circle cx="86.96" cy="55.89" r="9.2" fill="#b8e9f4"></circle>
      <path
        fill="#64878e"
        d="M8.04 52.98S3.08 64.56 5.86 76.14l-3.49-2.55s.28-5.78 1.99-12.15c1.72-6.39 3.68-8.46 3.68-8.46zm111.92 0s4.96 11.58 2.18 23.16l3.49-2.55s-.28-5.78-1.99-12.15c-1.72-6.39-3.68-8.46-3.68-8.46z"
      ></path>
      <path
        fill="#e06055"
        d="m61.85 65.7l-5.39 12.95c-.56 1.34.43 2.82 1.88 2.82h10.57c1.44 0 2.43-1.46 1.89-2.79l-5.18-12.95c-.68-1.69-3.07-1.71-3.77-.03z"
      ></path>
      <path
        fill="#eda29b"
        d="M63.46 67.6c-1.09-.31-1.42 1.41-2 2.92c-.96 2.53-1.22 3.71-.69 3.9c.7.26 1.31-.54 2.25-2.83c.9-2.15 1.36-3.73.44-3.99z"
      ></path>
      <path
        fill="#eceff1"
        d="M48.39 90.33v10.21m10.58-10.21v10.21m10.59-10.21v10.21m10.58-10.21v10.21"
      ></path>
      <path
        fill="#b8e9f4"
        d="M81.99 100.54H46.21c-4.91 0-8.9-3.98-8.9-8.9v-1.31h53.57v1.31c0 4.91-3.98 8.9-8.89 8.9z"
      ></path>
      <path
        fill="#546e7a"
        stroke="#546e7a"
