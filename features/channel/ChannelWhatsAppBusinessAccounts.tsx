...
const ChannelWhatsAppBusinessAccounts = () => {
  return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 place-items-center">
        <div className="lg:max-w-lg md:max-w-sm sm:py-4 text-center sm:text-center md:text-left">
          ...
          <p className="text-slate-400 text-xl font-normal mb-4 mb-md-6">
            Create a business account for WhatsApp, connect it with Chatwoot and
        ...
        <div className="lg:max-w-lg md:max-w-sm">
          <Image
            width={512}
            height={375}
            src="https://www.chatwoot.com/features/channels/whatsapp.png"
            alt="img"
            className=""
          />
        </div>
...
export default ChannelWhatsAppBusinessAccounts
