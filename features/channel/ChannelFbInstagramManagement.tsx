...
const ChannelFbInstagramManagement = () => {
  return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 place-items-center">
        <div className="lg:max-w-lg md:max-w-sm">
          <Image
            width={512}
            height={741}
            src="/images/features/channels/fb.png"
            alt="img"
            className="h-auto"
          />
        </div>
        <div className="lg:max-w-lg md:max-w-sm sm:py-4 text-center sm:text-center md:text-left">
          ...
          <p className="text-slate-400 text-xl font-normal mb-4 mb-md-6">
            Connect your Facebook page &amp; Instagram DM with Chatwoot, and see
            all the conversations from Messenger.
          </p>
          {features.map((item) => (
...
export default ChannelFbInstagramManagement
