...
const features = [
  {
    ...
    href: "##",
    image: "https://www.chatwoot.com/product.svg",
    children: [
      {
        featureId: 1,
  ...
  },
  {
    ...
    href: "##",
    image: "https://www.chatwoot.com/manage.svg",
    children: [
      {
        featureId: 2,
        name: "Labels",
  ...
  },
  {
    ...
    href: "##",
    image: "https://www.chatwoot.com/analyse.svg",
    children: [
      {
        featureId: 3,
        name: "Live view",
  ...
  },
  {
    ...
    href: "##",
    image: "https://www.chatwoot.com/productivity.svg",
    children: [
      {
        featureId: 4,
  ...
  },
  {
    ...
    href: "##",
    image: "https://www.chatwoot.com/integrations.svg",
    children: [
      {
        featureId: 5,
        name: "WhatsApp",
...
const resources = [
  {
    ...
    icon: (
      <svg
        ...
        aria-hidden="true"
        role="img"
        className="icon h-5 w-5 text-woot"
        width="1em"
        height="1em"
        viewBox="0 0 24 24"
      >
...
const HeaderMobilePopoverMenu = () => {
  return (
    <div className="lg:hidden -mr-2">
      <Popover>
        {({ open }) => (
          <>
            <Popover.Button className="inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-woot-dark">
            ...
            >
              <Popover.Panel className="absolute inset-x-0 mt-2 z-30 origin-top-right transform lg:hidden">
                <div className="divide-y-2 divide-gray-50 rounded-b-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5 max-h-[calc(100vh-75px)] overflow-y-auto">
                      ...
                      <li>
                        <Disclosure>
                          {({ open }) => (
                            <>
                              <Disclosure.Button
                                className={`p-2 -mx-2 flex items-center justify-between w-full rounded-lg ${
                                  open
                              ...
                              >
                                <span>Product</span>
                                <ChevronRight
                                  className={`icon h-5 w-5 text-gray-400 transition-transform
                                    ${open ? " rotate-90" : ""}
                                  `}
                                />
                              </Disclosure.Button>
                  ...
                  <div className="grid grid-cols-2 gap-8 px-5 pt-5 pb-6">
                    ...
                    <a
                      aria-current="page"
                      href="/helping"
                      className="router-link-active router-link-exact-active text-slate-600"
                    >
                      Help Center
                    </a>
                  </div>

                  <div className="px-5 pt-5 pb-6 grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-2">
                    <a
                      href="https://app.chatwoot.com/app/login?utm_source=navbar-link"
                      rel="noopener noreferrer"
                      className="w-full block text-center py-2 rounded-lg text-white bg-woot-dark"
                    >
                      Create an account{" "}
                    </a>
                    <a
                      ...
                      rel="noopener noreferrer"
                      className="w-full block text-center py-2 rounded-lg text-slate-600 border"
                    >
                      Login
                    </a>
                  </div>
...
export default HeaderMobilePopoverMenu;
